...
public static class ExtensionsBase
{
    ...
    public static double lastTimeTimestamp;
    ...
    public static Vector3 DeserializeVector3(this Dictionary<string, object> dict)
    {
        return new Vector3(dict.Extract<float>("x"), dict.Extract<float>("y"), dict.Extract<float>("z"));
    }

    public static Dictionary<string, object> SerializeColor(this Color color, bool showAlpha, bool hdr)
    {
        ...
        res["b"] = color.b;
        res["a"] = color.a;
        res["showAlpha"] = showAlpha;
        res["hdr"] = hdr;
        return res;
    }

    public static Color DeserializeColor(this Dictionary<string, object> dict)
    {
        return new Color(dict.Extract<float>("r"), dict.Extract<float>("g"), dict.Extract<float>("b"),
            dict.Extract<float>("a"));
    }
    ...
    {
        string rtn = "#" + ((int)(color.r * 255)).ToString("X2") + ((int)(color.g * 255)).ToString("X2") +
